		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#EntrepinaresSAPUI5employees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"EntrepinaresSAPUI5employees-display": {
								"semanticObject": "EntrepinaresSAPUI5employees",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Entrepinares.SAPUI5.employees",
									"url": sap.ui.require.toUrl("Entrepinares/SAPUI5/employees")
								}
							}
						}
					}
